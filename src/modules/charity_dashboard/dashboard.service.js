...
export const getStats = async (req, res, next) => {
    ...
    const Total_Donations    = await donationModel.countDocuments(filter);
    const Pending_Donations  = await donationModel.countDocuments({ ...filter, status: donationStatus.pending });
    const Accepted_Donations = await donationModel.countDocuments({ ...filter, status: donationStatus.accepted });
    const Rejected_Donations = await donationModel.countDocuments({ ...filter, status: donationStatus.rejected });
